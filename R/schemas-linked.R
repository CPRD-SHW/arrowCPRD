...
# NACRAS Cancer
.schemas_linked_cancer <- list(

  linked_cancer_tumour = list(
    date_cols = c("diagnosisdatebest", "vitalstatusdate", "date_first_event",
                  "date_first_surgery"),
    ...
    col_types = c(
      ...
      tumour_id = "character",
      ethnicity = "character",
      ethnicityname = "character",
      diagnosisdatebest = "character",
      diagnosisdateflag = "integer",
      basisofdiagnosis = "integer",
      site_icd10_o2 = "character",
      site_icd10_o2_3char = "character",
      morph_icd10_o2 = "integer",
      behaviour_icd10_o2 = "character",
      site_coded = "character",
      site_coded_desc = "character",
      site_coded_3char = "character",
      coding_system = "integer",
      coding_system_desc = "character",
      morph_coded = "character",
      behaviour_coded = "character",
      behaviour_coded_desc = "character",
      histology_coded = "character",
      histology_coded_desc = "character",
      grade = "character",
      tumoursize = "integer",
      nodesexcised = "integer",
      nodesinvolved = "integer",
      tumourcount = "integer",
      bigtumourcount = "integer",
      route_code = "character",
      final_route = "character",
      stage_best = "character",
      t_best = "character",
      n_best = "character",
      m_best = "character",
      stage_best_system = "character",
      t_img = "character",
      n_img = "character",
      m_img = "character",
      stage_img = "character",
      stage_img_system = "integer",
      t_path = "character",
      n_path = "character",
      m_path = "character",
      stage_path = "character",
      stage_path_system = "integer",
      stage_path_pretreated = "character",
      chrl_tot_27_03 = "integer",
      chrl_tot_78_06 = "integer",
      er_status = "character",
      er_score = "character",
      pr_status = "character",
      pr_score = "character",
      her2_status = "character",
      npi = "numeric",
      dukes = "character",
      figo = "character",
      ...
      screendetected = "character",
      screeningstatuscosd_code = "character",
      screeningstatuscosd_name = "character",
      screeningstatusfull_code = "character",
      screeningstatusfull_name = "character",
      laterality = "character",
      dco = "character",
      vitalstatus = "character",
      vitalstatusdate = "character",
      date_first_event = "character",
      date_first_surgery = "character",
      creg_code = "character",
      creg_name = "character",
      multifocal = "character",
      clarks = "character",
      breslow = "character",
      excisionmargin = "character"
    )
  ),


  linked_cancer_treatment = list(
    ...
    col_types = c(
      ...
      pracid = "character",
      tumour_id = "character",
      number_of_tumours = "integer",
      eventcode = "character",
      eventdesc = "character",
      eventdate = "character",
      within_six_months_flag = "integer",
      six_months_after_flag = "integer",
      opcs4_code = "character",
      opcs4_name = "character",
      radiocode = "character",
      radiodesc = "character",
      imagingcode_nicip = "character",
      imagingcode_snomedct = "character",
      imagingdesc = "character",
      imagingmodality = "character",
      imagingsite = "character",
      lesionsize = "integer",
      chemo_all_drugs = "character",
      chemo_drug_group = "character"
    )
  )
)
